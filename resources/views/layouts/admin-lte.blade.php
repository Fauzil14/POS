...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      <img src="{{ asset('favicon.ico') }}" alt="Katastima Logo" class="brand-image img-square elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"><strong>Katastima</strong></span>
    </a>
            ...
            <ul class="nav nav-treeview pl-3" style="display: none;">
              ...
              <li class="nav-item">
                <a href="charts/inline.html" class="nav-link">
                  <i class="fas fa-sort-down fa-rotate-270"></i>
                  <p class="pl-2">Transaksi Penjualan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="charts/uplot.html" class="nav-link">
                  <i class="fas fa-sort-down fa-rotate-270"></i>
                  <p class="pl-2">Laba/Rugi</p>
                </a>
              </li>
            </ul>
          </li>
